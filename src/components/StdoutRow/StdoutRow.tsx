 ...
 * filler characters.
 */
const StdoutRow: React.FC<StdoutRowProps> = React.memo(({ filler = '.', fillerWidth = 8, style = {}, text }) => {
  /**
   ...
   */
  const memoizedFiller = useMemo(() => filler.repeat(fillerCount), [filler, fillerCount]);
