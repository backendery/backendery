...
type AnimateSignalStripProps = {
   ...
   */
  readonly maxNumberOfSymbols: number;
 ...
 * remove symbols.
 * @param {string} [initialSymbols] An optional string that represents the starting
 ...
 */
const AnimateSignalStrip: React.FC<AnimateSignalStripProps> = (props) => {
  /**
  ...
  const animateSymbols = () => {
    ...
    if (isAdding) {
      ...
      setSymbols((previousSeqSymbols) => previousSeqSymbols + props.symbol.repeat(countToAdd));
    } else if (canRemove) {
      /**
      ...
      setSymbols((previousSeqSymbols) => previousSeqSymbols.slice(0, currentLength - countToRemove));
    }
  };
